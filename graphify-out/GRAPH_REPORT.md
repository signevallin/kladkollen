...
## Corpus Check
- 190 files · ~470,308 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1078 nodes · 2645 edges · 149 communities (74 shown, 75 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 6 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fee56cda`
...
Cohesion: 0.23
Nodes (9): Index(), CropModal(), makeStyles(), makeStyles(), Props, QueryState(), styles, Toggle() (+1 more)
...
### Community 8 - "useSettings"
Cohesion: 0.06
Nodes (72): ChildOutfit(), makeStyles(), GarmentDetail(), makeStyles(), COLD_LEVELS, makeStyles(), Profile(), THEME_OPTIONS (+64 more)

### Community 9 - "ThemeProvider.tsx"
Cohesion: 0.15
Nodes (14): makeStyles(), Privacy(), SECTIONS, DayToNightShareCard(), makeStyles(), darkColors, darkTheme, lightColors (+6 more)
...
### Community 16 - "BrandInput.tsx"
Cohesion: 0.83
Nodes (3): BrandInput(), makeStyles(), brandSuggestions()
...
Cohesion: 0.05
Nodes (55): buildPrompt(), config, handler(), SUBCATEGORY_HINT, langName(), GarmentDraft, CATEGORIES, COLOR_ORDER (+47 more)
...
Cohesion: 0.13
Nodes (20): setApiLang(), Dict, en, enBySource, Lang, LANGS, LOCALES, sv (+12 more)

### Community 28 - "garment-detail.tsx"
Cohesion: 0.05
Nodes (88): AddGarment(), FAMILY_STATUS_LABELS, FamilyStatus, makeStyles(), SIZES, ImportEmail(), makeStyles(), Pending (+80 more)
...
Cohesion: 0.23
Nodes (10): PUBLIC_ROUTES, RootLayout(), makeStyles(), ToastHost(), ThemeProvider(), useThemeControl(), hydrateCache(), initSentry() (+2 more)
...
### Community 40 - "ConfirmDialog.tsx"
Cohesion: 0.67
Nodes (3): ConfirmHost(), ConfirmRequest, makeStyles()

### Community 42 - "SaleTab.tsx"
Cohesion: 0.67
...
- **Why does `expo-router` connect `garment-detail.tsx` to `family.tsx`, `expo`, `useTheme`, `useSettings`, `login.tsx`, `SaleTab.tsx`, `onboarding.tsx`, `entitlements.tsx`, `stats.tsx`, `CreateOutfitView.tsx`, `wardrobe.tsx`, `GarmentSetSection.tsx`, `app/_layout.tsx`?**
