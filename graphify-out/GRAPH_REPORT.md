...
## Corpus Check
- 172 files · ~436,954 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 945 nodes · 2221 edges · 135 communities (62 shown, 73 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.68)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ecc9c880`
...
Cohesion: 0.08
Nodes (62): config, config, handler(), handler(), handler(), config, config, dedupeItems() (+54 more)

### Community 1 - "WishlistAddModals.tsx"
Cohesion: 0.17
Nodes (18): config, SUBCATEGORY_HINT, DraftCard(), FAMILY_STATUS_LABELS, makeStyles(), Props, SIZES, Props (+10 more)

### Community 2 - "family.tsx"
Cohesion: 0.09
Nodes (41): daysSince(), handler(), sendBatch(), today(), Family(), loadChildren(), makeStyles(), reminderLabel() (+33 more)
...
Cohesion: 0.19
Nodes (11): Index(), makeStyles(), Privacy(), SECTIONS, makeStyles(), ResetPassword(), Button(), Props (+3 more)
...
Cohesion: 0.10
Nodes (24): Group, GROUPS, HowItWorks(), Item, makeStyles(), makeStyles(), SECTIONS, Terms() (+16 more)
...
Cohesion: 0.05
Nodes (81): AddGarment(), FAMILY_STATUS_LABELS, FamilyStatus, GarmentDraft, makeStyles(), GarmentDetail(), makeStyles(), SIZES (+73 more)
...
### Community 40 - "useSettings"
Cohesion: 0.16
Nodes (17): makeStyles(), monthLabel(), MyOutfits(), STYLE_TAGS, weekdayLabels(), CropModal(), makeStyles(), GarmentPicker() (+9 more)
...
Cohesion: 0.21
Nodes (10): makeStyles(), PartnerCloset(), CapsuleView(), makeStyles(), DayToNightShareCard(), makeStyles(), Props, RESIZE_TO_FIT (+2 more)

### Community 141 - "home.tsx"
Cohesion: 0.09
Nodes (27): Home(), INTENSITY_LABELS, makeStyles(), AppleMusicBadge(), GarmentSetSection(), makeStyles(), Props, makeStyles() (+19 more)
...
- **Why does `expo-router` connect `expo-router` to `WishlistAddModals.tsx`, `family.tsx`, `expo`, `notifications.tsx`, `useTheme`, `pregnancy-wardrobe.tsx`, `entitlements.tsx`, `useSettings`, `SignedImage.tsx`, `ThemeProvider.tsx`, `home.tsx`, `ArchiveView.tsx`, `stats.tsx`, `wardrobe.tsx`, `garment-detail.tsx`, `settings.tsx`?**
