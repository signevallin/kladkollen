...
## Corpus Check
- 191 files · ~471,736 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1081 nodes · 2654 edges · 151 communities (75 shown, 76 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 6 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `430794c7`
...
### Community 1 - "goBack"
Cohesion: 0.12
Nodes (20): Group, GROUPS, HowItWorks(), Item, makeStyles(), makeStyles(), Member, Partner() (+12 more)
...
Cohesion: 0.18
Nodes (20): INTENSITY_LABELS, FamilyOutfits(), makeStyles(), Member, seasonalOrFull(), OUTFIT_CONTEXTS, useEntitlements(), ageMonths() (+12 more)

### Community 5 - "profile.tsx"
Cohesion: 0.17
Nodes (18): COLOR_PROFILES, GENDERS, LIFESTYLE, STIL_PROFIL, STYLES, confirmDialog(), ColorAnalysis(), ColorAnalysisData (+10 more)
...
Cohesion: 0.13
Nodes (27): GarmentDetail(), makeStyles(), Home(), makeStyles(), Inspiration(), makeStyles(), makeStyles(), monthLabel() (+19 more)

### Community 9 - "useTheme"
Cohesion: 0.09
Nodes (31): Index(), makeStyles(), ResetPassword(), Button(), Props, styles, Variant, CapsuleView() (+23 more)
...
Cohesion: 0.19
Nodes (13): AddGarment(), FAMILY_STATUS_LABELS, FamilyStatus, makeStyles(), SIZES, newImageId(), base64ToBytes(), downscaleForUpload() (+5 more)
...
Cohesion: 0.16
Nodes (16): ChildOutfit(), makeStyles(), DayToNightShareCard(), makeStyles(), GarmentPicker(), makeStyles(), Props, makeStyles() (+8 more)
...
Cohesion: 0.23
Nodes (9): BrandInput(), makeStyles(), makeStyles(), Props, WishlistAddModals(), brandSuggestions(), COMMON_BRANDS, parsePrice() (+1 more)
...
Cohesion: 0.15
Nodes (15): buildPrompt(), config, handler(), SUBCATEGORY_HINT, langName(), GarmentDraft, DraftCard(), FAMILY_STATUS_LABELS (+7 more)
...
### Community 135 - "OutfitShareCard.tsx"
Cohesion: 0.36
...
- **Why does `expo-router` connect `useTheme` to `goBack`, `family.tsx`, `expo`, `home.tsx`, `profile.tsx`, `pregnancy-wardrobe.tsx`, `my-outfit.tsx`, `garment-detail.tsx`, `entitlements.tsx`, `stats.tsx`, `WishlistAddModals.tsx`, `CreateOutfitView.tsx`, `wardrobe.tsx`, `GarmentSetSection.tsx`, `settings.tsx`, `supabase.ts`, `app/_layout.tsx`, `DraftCard.tsx`, `ArchiveView.tsx`?**
