        ...
        <QueryState loading={loading} error={error} onRetry={refetch} isEmpty={children.length === 0}
          ...
          {children.map(child => (
            <View key={child.id} style={styles.childCard}>
              ...
              >
                {child.avatar_url
                  ? <SignedImage path={child.avatar_url} style={styles.childAvatar} resizeMode="cover" transform={{ width: 160, height: 160, resize: 'cover', format: 'origin' }} />
        ...
        {showAdd ? (
          <View style={styles.addBox}>
            ...
            <TouchableOpacity style={styles.formAvatarWrap} onPress={pickFormAvatar} accessibilityLabel={tr('Välj bild')}>
              {avatarUrl
                ? <SignedImage path={avatarUrl} style={styles.formAvatar} resizeMode="cover" transform={{ width: 220, height: 220, resize: 'cover', format: 'origin' }} />
