    ...
    return (
      <SafeAreaView style={styles.container}>
        <ScrollView contentContainerStyle={styles.scroll}>
          ...
          <TextInput style={styles.nameInput} placeholder="t.ex. Fredagslook 🍒" placeholderTextColor="rgba(108,77,56,0.4)" value={outfitName} onChangeText={setOutfitName} />
          ...
          <View style={styles.calendarContainer}>
            ...
            <View style={styles.calendarLegend}>
              <View style={styles.legendItem}>
                <View style={[styles.legendDot, { backgroundColor: '#402D21' }]} />
...
const styles = StyleSheet.create({
  ...
  title: { fontFamily: 'Poppins_700Bold', fontSize: 28, color: '#402D21' },
  ...
  iconBtnText: { fontFamily: 'Lora_400Regular', fontSize: 18, color: '#402D21' },
  ...
  monthNavArrow: { fontFamily: 'Lora_400Regular', fontSize: 28, color: '#6C4D38', paddingHorizontal: 12 },
  monthTitle: { fontFamily: 'Poppins_600SemiBold', fontSize: 18, color: '#402D21' },
  weekdayRow: { flexDirection: 'row', marginBottom: 4 },
  weekdayLabel: { fontFamily: 'Poppins_600SemiBold', flex: 1, textAlign: 'center', fontSize: 11, color: 'rgba(108,77,56,0.6)' },
  ...
  dayNumber: { fontFamily: 'Lora_500Medium', fontSize: 11, color: '#402D21', marginBottom: 2 },
  dayNumberToday: { color: '#6C4D38', fontWeight: '700' },
  dayNumberPast: { color: 'rgba(108,77,56,0.35)' },
  dayCellImage: { width: 26, height: 26, borderRadius: 6 },
  dayCellOutfitDot: { fontFamily: 'Lora_400Regular', fontSize: 10, color: '#402D21' },
  dayCellPlus: { fontFamily: 'Lora_400Regular', fontSize: 12, color: 'rgba(108,77,56,0.2)' },
  calendarLegend: { flexDirection: 'row', gap: 16, justifyContent: 'center', marginTop: 12 },
  legendItem: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  legendDot: { width: 10, height: 10, borderRadius: 5 },
  legendText: { fontFamily: 'Lora_400Regular', fontSize: 11, color: 'rgba(108,77,56,0.6)' },
  ...
  modalTitle: { fontFamily: 'Poppins_700Bold', fontSize: 18, color: '#402D21', flex: 1 },
  modalClose: { fontFamily: 'Lora_400Regular', fontSize: 18, color: '#6C4D38', paddingLeft: 12 },
  outfitPickerItem: { flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: 'rgba(207,181,158,0.3)', borderRadius: 16, padding: 12, marginBottom: 10, borderWidth: 1, borderColor: 'rgba(108,77,56,0.2)' },
  outfitPickerImages: { flexDirection: 'row', gap: 4 },
  outfitPickerImage: { width: 48, height: 48, borderRadius: 10 },
  outfitPickerImageEmpty: { width: 48, height: 48, borderRadius: 10, backgroundColor: 'rgba(207,181,158,0.4)', alignItems: 'center', justifyContent: 'center' },
  outfitPickerInfo: { flex: 1 },
  outfitPickerName: { fontFamily: 'Poppins_600SemiBold', fontSize: 14, color: '#402D21' },
  outfitPickerGarments: { fontFamily: 'Lora_400Regular', fontSize: 11, color: '#6C4D38', marginTop: 2 },
  emptyTab: { alignItems: 'center', paddingVertical: 40, gap: 8 },
  emptyTabText: { fontFamily: 'Lora_500Medium', color: '#6C4D38', fontSize: 15 },
  emptyTabHint: { fontFamily: 'Lora_400Regular', color: 'rgba(108,77,56,0.5)', fontSize: 13, fontStyle: 'italic' },

  // Day detail modal
  dayDetailOutfitName: { fontFamily: 'Poppins_700Bold', fontSize: 20, color: '#402D21', marginBottom: 4 },
  dayDetailGarments: { fontFamily: 'Lora_400Regular', fontSize: 12, color: '#6C4D38', fontStyle: 'italic' },
  dayDetailImage: { width: 90, height: 90, borderRadius: 14 },
  dayDetailActions: { flexDirection: 'row', gap: 10, marginTop: 8 },
  dayDetailChangeBtn: { flex: 1, backgroundColor: 'rgba(207,181,158,0.4)', borderRadius: 14, padding: 14, alignItems: 'center', borderWidth: 1, borderColor: 'rgba(108,77,56,0.3)' },
  dayDetailChangeBtnText: { fontFamily: 'Poppins_600SemiBold', color: '#6C4D38', fontSize: 14 },
  dayDetailRemoveBtn: { flex: 1, backgroundColor: 'rgba(207,181,158,0.2)', borderRadius: 14, padding: 14, alignItems: 'center', borderWidth: 1, borderColor: 'rgba(108,77,56,0.2)' },
  dayDetailRemoveBtnText: { fontFamily: 'Lora_400Regular', color: 'rgba(108,77,56,0.6)', fontSize: 14 },
  dayDetailEmpty: { alignItems: 'center', paddingVertical: 24, gap: 16 },
  dayDetailEmptyText: { fontFamily: 'Lora_400Regular', color: 'rgba(108,77,56,0.5)', fontSize: 14, fontStyle: 'italic' },
  dayDetailAddBtn: { backgroundColor: '#402D21', borderRadius: 14, padding: 14, paddingHorizontal: 24 },
  dayDetailAddBtnText: { fontFamily: 'Poppins_600SemiBold', color: '#FEFAF8', fontSize: 15 },

  // Outfits
  createHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20 },
  cancelText: { fontFamily: 'Lora_400Regular', color: '#6C4D38', fontSize: 14 },
  saveText: { fontFamily: 'Poppins_600SemiBold', color: '#6C4D38', fontSize: 14 },
  nameInput: { fontFamily: 'Lora_400Regular', backgroundColor: 'rgba(207,181,158,0.3)', borderRadius: 12, padding: 14, color: '#402D21', fontSize: 16, borderWidth: 1, borderColor: 'rgba(108,77,56,0.2)', marginBottom: 16 },
  label: { fontFamily: 'Poppins_600SemiBold', color: '#402D21', fontSize: 14, marginBottom: 12, marginTop: 8 },
  selectedPreview: { marginBottom: 16, backgroundColor: 'rgba(207,181,158,0.3)', borderRadius: 16, padding: 12 },
  ...
  selectedImageEmpty: { width: 60, height: 60, borderRadius: 10, backgroundColor: 'rgba(207,181,158,0.5)', alignItems: 'center', justifyContent: 'center' },
  wishlistImageBorder: { borderWidth: 2, borderColor: '#6C4D38', borderRadius: 10 },
  wishlistImageEmptyBorder: { borderWidth: 2, borderColor: 'rgba(207,181,158,0.5)', borderStyle: 'dashed' },
  notOwnedBadgeTiny: { backgroundColor: 'rgba(207,181,158,0.3)', borderRadius: 4, paddingHorizontal: 4, paddingVertical: 1, marginTop: 2 },
  notOwnedBadgeTinyText: { fontFamily: 'Poppins_600SemiBold', fontSize: 7, color: '#6C4D38' },
  selectedName: { fontFamily: 'Lora_400Regular', fontSize: 9, color: '#6C4D38', marginTop: 4, textAlign: 'center' },
  garmentGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 10, marginBottom: 16 },
  garmentItem: { width: '30%', alignItems: 'center', backgroundColor: 'rgba(207,181,158,0.3)', borderRadius: 14, padding: 8, borderWidth: 1, borderColor: 'rgba(108,77,56,0.15)' },
  garmentItemSelected: { borderColor: '#402D21', borderWidth: 2, backgroundColor: 'rgba(64,45,33,0.25)' },
  garmentImage: { width: '100%', height: 70, borderRadius: 10, marginBottom: 4 },
  garmentImageEmpty: { width: '100%', height: 70, borderRadius: 10, backgroundColor: 'rgba(207,181,158,0.5)', alignItems: 'center', justifyContent: 'center', marginBottom: 4 },
  checkmark: { position: 'absolute', top: 6, right: 6, backgroundColor: '#402D21', borderRadius: 10, width: 20, height: 20, alignItems: 'center', justifyContent: 'center' },
  checkmarkText: { fontFamily: 'Poppins_700Bold', color: '#FEFAF8', fontSize: 11 },
  garmentName: { fontFamily: 'Lora_400Regular', fontSize: 10, color: '#6C4D38', textAlign: 'center' },
  wishlistGarmentItem: { borderColor: 'rgba(207,181,158,0.35)', backgroundColor: 'rgba(207,181,158,0.06)' },
  wishlistImageEmptyStyle: { backgroundColor: 'rgba(207,181,158,0.1)' },
  notOwnedBadge: { backgroundColor: 'rgba(207,181,158,0.25)', borderRadius: 6, paddingHorizontal: 5, paddingVertical: 2, marginBottom: 2, alignSelf: 'center' },
  notOwnedBadgeText: { fontFamily: 'Poppins_700Bold', fontSize: 8, color: '#6C4D38', letterSpacing: 0.3 },
  wishlistToggle: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: 'rgba(207,181,158,0.1)', borderRadius: 14, padding: 14, marginBottom: 10, borderWidth: 1, borderColor: 'rgba(207,181,158,0.25)' },
  wishlistToggleLeft: { flexDirection: 'row', alignItems: 'center', gap: 10 },
  wishlistToggleIcon: { fontFamily: 'Lora_400Regular', fontSize: 22 },
  wishlistToggleTitle: { fontFamily: 'Poppins_600SemiBold', fontSize: 14, color: '#402D21' },
  wishlistToggleSub: { fontFamily: 'Lora_400Regular', fontSize: 11, color: 'rgba(207,181,158,0.6)', marginTop: 1 },
  wishlistToggleArrow: { fontFamily: 'Lora_400Regular', color: '#6C4D38', fontSize: 13 },
  filterBar: { flexDirection: 'row', marginBottom: 10, gap: 8 },
  filterBtn: { flex: 1, paddingVertical: 8, paddingHorizontal: 10, borderRadius: 12, backgroundColor: 'rgba(207,181,158,0.3)', borderWidth: 1, borderColor: 'rgba(108,77,56,0.2)', alignItems: 'center' },
  filterBtnActive: { backgroundColor: '#402D21', borderColor: '#402D21' },
  filterBtnText: { fontFamily: 'Lora_500Medium', color: '#6C4D38', fontSize: 12 },
  filterBtnTextActive: { color: '#FEFAF8' },
  dropdown: { marginBottom: 10, backgroundColor: 'rgba(207,181,158,0.5)', borderRadius: 14, padding: 10, borderWidth: 1, borderColor: 'rgba(108,77,56,0.2)' },
  ...
  goBtn: { backgroundColor: '#402D21', borderRadius: 14, padding: 14, paddingHorizontal: 24 },
  goBtnText: { fontFamily: 'Poppins_600SemiBold', color: '#FEFAF8', fontSize: 14 },
  outfitCard: { backgroundColor: 'rgba(207,181,158,0.3)', borderRadius: 20, padding: 16, marginBottom: 14, borderWidth: 1, borderColor: 'rgba(108,77,56,0.15)', gap: 10 },
  collageCard: { backgroundColor: 'rgba(207,181,158,0.3)', borderRadius: 20, padding: 16, marginBottom: 14, borderWidth: 1, borderColor: 'rgba(108,77,56,0.15)', gap: 10 },
  ...
  outfitName: { fontFamily: 'Poppins_600SemiBold', fontSize: 16, color: '#402D21' },
  outfitDate: { fontFamily: 'Lora_400Regular', fontSize: 11, color: '#6C4D38', fontStyle: 'italic' },
  outfitImages: { flexDirection: 'row', gap: 8 },
  outfitImage: { width: 70, height: 70, borderRadius: 12 },
  outfitImageEmpty: { width: 70, height: 70, borderRadius: 12, backgroundColor: 'rgba(207,181,158,0.4)', alignItems: 'center', justifyContent: 'center' },
  outfitGarments: { fontFamily: 'Lora_400Regular', fontSize: 11, color: '#6C4D38', fontStyle: 'italic' },
  holdToDelete: { fontFamily: 'Lora_400Regular', fontSize: 9, color: 'rgba(108,77,56,0.3)', textAlign: 'center' },
})